...
Alison_Neuron_SGA::Alison_Neuron_SGA(void) : DefaultGUIModel("Alison_Neuron_SGA", ::vars, ::num_vars) {
    setWhatsThis(
    "<p><b>Alison_Neuron_SGA:</b><br>This module simulates a neuron with an A Current.</p>");
...
Alison_Neuron_SGA::~Alison_Neuron_SGA(void) {}

void Alison_Neuron_SGA::execute(void) {
...
void Alison_Neuron_SGA::update(DefaultGUIModel::update_flags_t flag) {
    switch (flag) {
        case INIT:
...
void Alison_Neuron_SGA::initParameters() {
    V0 = -55.038; // mV
    G_Na_max = 0.24;
    G_K_max = 0.011;
    G_L = 0.0018;
...
void Alison_Neuron_SGA::solve(double dt, double *y) {
    double dydt[7];
    derivs(y, dydt);
...
void Alison_Neuron_SGA::derivs(double *y, double *dydt) {
